...
function playPad ( padNumber ) {
    var weightedPad = 0;
    if ((padNumber > 11) ){
    weightedPad = ((padNumber % 12) + 1);
    }
    switch(weightedPad) {
      
        case (1):
            //var padOne = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/SD0025.mp3');
            var padOne = new Audio("drumkits/kit1/chop1.wav");
            padOne.load();
            padOne.play();
            break;
        case (2):
            var padTwo = new Audio('drumkits/kit1/kick1.wav');
            padTwo.load();
            padTwo.play();
            break;
        case (3):
            var padThree = new Audio('drumkits/kit1/snare2.wav');
            padThree.load();
            padThree.play();
            break;
        case (4):
            var padFour = new Audio('drumkits/kit1/hihat2.wav');
            padFour.load();
            padFour.play();
            break;
        case (5):
